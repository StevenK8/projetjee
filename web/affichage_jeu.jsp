    ...
    <body class="background">
        <div class="float-left">
            <form name="form" method="post" action="user.jsp">
                <button class="btn btn-secondary" name="submit" type="submit" id="submit">
        ...
        <div class="container text-center">
            ...
            <%
                ...
                //sans session
                int i=0,j=0,nPlusDeVingt=0,sommeCoups=0;
                boolean[][] carre = new boolean[2][2];
                boolean ignoreGame = false;
                ...
                while(nbparties>0){
                    ...
                    while(!carre[1][1] && nbcoups<20){ // Chaque partie
                        ...
                        nbcoups++;
                        /*
                        out.print("<table class='table-bordered' border='1'>");
                            out.print("<tr>");
                                out.print("<td>"+(carre[0][0]?'X':'O')+"</td>");
                                out.print("<td>"+(carre[0][1]?'X':'O')+"</td>");
                            out.print("<tr>");
                            out.print("<tr>");
                                out.print("<td>"+(carre[1][0]?'X':'O')+"</td>");
                                out.print("<td>"+(carre[1][1]?'X':'O')+"</td>");
                            out.print("<tr>");
                        out.print("</table>");*/
                        if(nbcoups >= 20){
                            ignoreGame = true;
            ...
            <h5>Parties ignorées (plus de 20 coups) : <%=Integer.toString(nPlusDeVingt)%></h5>
            <h5>Nombre de coups moyens : <%=Integer.toString(sommeCoups/(Integer.parseInt(request.getParameter("nbparties"))-nPlusDeVingt))%></h5>
        </div>
    </body>
</html>
